...
export class CategoryService {
  ...
  // BehaviorSubject: speichert den zuletzt gesendeten Wert und sendet diesen neuen Abonnenten sofort nach der Anmeldung
  // => aktuellen Wert zugreifen/neue Werte reagieren, ohne auf den nächsten Datenfluss warten zu müssen.
